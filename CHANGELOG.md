...
- **Canvas Notification Pill**: If a track has no live video canvas available, displays a sleek frosted top banner: *"No live video canvas for this track • Playing standard artwork"* that automatically fades out after 3.5 seconds.
